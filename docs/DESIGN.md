...
- Raleway weight 300 (light) for display — ethereal, whisper-thin headings
...
- Raleway bold uppercase for specific CTA labels
...
## 3. Typography Rules
### Font Families
- **Display**: `Raleway`, fallback: `sans-serif`
- **Display Bold**: `Raleway`, fallback: `sans-serif`
- **Body / UI**: `Inter`, fallback: `Inter Fallback`
- **Monospace**: `Geist Mono` or `ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas`
### Hierarchy
| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Raleway | 48px (3.00rem) | 300 | 1.08 (tight) | -0.96px | Whisper-thin, ethereal |
| Section Heading | Raleway | 36px (2.25rem) | 300 | 1.17 (tight) | normal | Light display |
| Card Heading | Raleway | 32px (2.00rem) | 300 | 1.13 (tight) | normal | Light card titles |
...
| Button Uppercase | Raleway | 14px (0.88rem) | 700 | 1.10 (tight) | 0.7px | `text-transform: uppercase` |
...
### Principles
- **Light as the hero weight**: Raleway at 300 is the defining typographic choice. Where other design systems use bold for impact, ElevenLabs uses lightness — thin strokes that feel like audio waveforms, creating intrigue through restraint.
...
- **Raleway for emphasis**: A bold (700) uppercase variant of Raleway appears only in specific CTA button labels with 0.7px letter-spacing — the one place where the type system gets loud.
...
**Uppercase Raleway Button**
- Font: Raleway 14px weight 700
...
- **Typography-led rhythm**: The light-weight Raleway headings create visual "whispers" that draw the eye through vast white space.
### Border Radius Scale
...
## 7. Do's and Don'ts
### Do
- Use Raleway weight 300 for all display headings — the lightness IS the brand
...
- Use Raleway bold uppercase ONLY for specific CTA button labels
### Don't
- Don't use bold (700) Raleway for headings — weight 300 is non-negotiable
...
- "Create a hero on white background. Headline at 48px Raleway weight 300, line-height 1.08, letter-spacing -0.96px, black text. Subtitle at 18px Inter weight 400, line-height 1.60, letter-spacing 0.18px, #4e4e4e text. Two pill buttons: black (9999px, 0px 14px padding) and warm stone (rgba(245,242,239,0.8), 30px radius, 12px 20px padding, warm shadow rgba(78,50,23,0.04) 0px 6px 16px)."
- "Design a card: white background, 20px radius. Shadow: rgba(0,0,0,0.06) 0px 0px 0px 1px, rgba(0,0,0,0.04) 0px 1px 2px, rgba(0,0,0,0.04) 0px 2px 4px. Title at 32px Raleway weight 300, body at 16px Inter weight 400 letter-spacing 0.16px, #4e4e4e."
...
- "Create an uppercase CTA label: 14px Raleway weight 700, text-transform uppercase, letter-spacing 0.7px."
...
2. Raleway 300 for headings — never bold, the lightness is the identity
