        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_760px] gap-12 lg:gap-16 items-center">
          <FadeUp>
            <div className="max-w-[640px] space-y-4">
              ...
              <p className="text-body text-[#4e4e4e]">
                The two halves close into a loop: developers ship into the codebase, Context Layer
                reads it back into shared knowledge, and that knowledge feeds the next round of
                work.
              </p>
            </div>
          </FadeUp>
