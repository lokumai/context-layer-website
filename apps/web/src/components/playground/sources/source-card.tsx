...
export function SourceCard({ source }: { source: Source }) {
  ...
  return (
    <button
      ...
      className="text-left group bg-white rounded-card p-5 shadow-[var(--shadow-inset-border)] hover:shadow-[var(--shadow-card)] transition-all duration-300 border border-transparent hover:border-[rgba(0,0,0,0.04)]"
