...
export default async function Page(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-2xl mx-auto py-24 text-center">
      <div className="mx-auto w-[56px] h-[56px] rounded-[16px] bg-[#eff6ff] text-[#1d4ed8] flex items-center justify-center mb-6">
        <Library size={28} strokeWidth={1.5} />
      </div>
      <p className="text-button-upper text-[#777169] mb-2">Coming Soon</p>
      <h1 className="text-section-heading text-black mb-4">Library</h1>
      <p className="text-body text-[#777169] mb-6">
        Every artifact you generate lives here — searchable, filterable, re-runnable.
      </p>
