...
const BRAND_ICONS = {
  ...
  gitlab: {
    path: "m23.6004 9.5927-.0337-.0862L20.3.9.7223a.871.871 0 0 0-.3188-.3548.8567.8567 0 0 0-.5066-.0934.8616.8616 0 0 0-.4868.1972.8743.8743 0 0 0-.2825.4535l-2.2079 6.7553H7.5028l-2.2079-6.7553a.8542.8542 0 0 0-.2818-.4543.8624.8624 0 0 0-.4868-.1972.8568.8568 0 0 0-.5066.0934.8731.8731 0 0 0-.3194.3548L.4327 9.505l-.0337.0871a6.0619 6.0619 0 0 0 2.0118 7.0064l.0113.0087.03.0218 4.976 3.7264 2.462 1.8633 1.4995 1.1331a1.0085 1.0085 0 0 0 1.2197 0l1.4995-1.1331 2.4619-1.8633 5.006-3.7489.0125-.0094a6.0628 6.0628 0 0 0 2.0094-7.0042z",
    color: "#FC6D26",
  },
  figma: {
...
const SOURCES: Source[] = [
  ...
  { id: "github", kind: "github", cx: 236, cy: 380, r: 30 },
  { id: "code", kind: "code", cx: 300, cy: 372, r: 28 },
  { id: "codebase", kind: "codebase", cx: 364, cy: 380, r: 26 },

  // Row 2 (Middle)
  { id: "pdf", kind: "pdf", cx: 188, cy: 428, r: 27 },
  { id: "mermaid", kind: "mermaid", cx: 266, cy: 436, r: 28 },
  { id: "notion", kind: "notion", cx: 334, cy: 436, r: 24 },
  { id: "jira", kind: "jira", cx: 412, cy: 424, r: 24 },

  // Row 3 (Bottom)
  { id: "slack", kind: "slack", cx: 232, cy: 492, r: 28 },
  { id: "gdrive", kind: "gdrive", cx: 300, cy: 496, r: 26 },
  { id: "md", kind: "md", cx: 368, cy: 488, r: 24 },
];
