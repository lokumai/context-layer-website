...
const variantClass: Record<Variant, string> = {
  ...
  hero: "inline-flex items-center gap-2 text-button rounded-warm-btn px-7 py-3 transition-transform hover:scale-[1.02] bg-[rgba(245,242,239,0.8)] text-black shadow-[var(--shadow-warm)]",
  compact:
